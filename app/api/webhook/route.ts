...
import { processWebhookEvent, storeWebhookEvent } from "@/lib/app/actions";
...
export async function POST(request: Request) {
  try {
    ...
    const data = JSON.parse(rawBody) as unknown;  // Type guard to check if the object has a 'meta' property.
