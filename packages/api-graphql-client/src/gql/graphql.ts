...
export type GetCurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, firstName?: string | null, lastName?: string | null, email: string, avatar?: string | null, organizations: Array<{ __typename?: 'Organization', id: string, name: string, slug: string, plan?: string | null, logo?: string | null }> } | null };
