...
export const KanbanAction = forwardRef<ActionProps, 'button'>(
  ({ className, style, ...props }, ref) => {
    return <Button ref={ref} {...props} tabIndex={0} variant="ghost" />
  },
)

export const KanbanHandle = forwardRef<ActionProps, 'button'>((props, ref) => {
  return (
...
export const KanbanRemove = forwardRef<ActionProps, 'button'>((props, ref) => {
  return (
