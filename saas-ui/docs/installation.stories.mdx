...
This step is only required if you want the column meta fields to be typesafe.

Install `@tanstack/react-table` in your project.

Create a `react-table.d.ts` file somewhere in your project, eg in `/types` (has to be a sub folder).
