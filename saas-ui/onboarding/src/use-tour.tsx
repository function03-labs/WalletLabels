...
export const useTour = (props: UseTourProps) => {
  ...
  const getNextProps = React.useCallback(
    ({ onClick, ...rest }) => {
      return {
        onClick: callAllHandlers(onClick, next),
        ...rest,
      }
    },
    [next],
  ...
  const getPrevProps = React.useCallback(
    ({ onClick, ...rest }) => {
      return {
        onClick: callAllHandlers(onClick, prev),
        ...rest,
      }
    },
    [prev],
  ...
  const getDismissProps = React.useCallback(
    ({ onClick, ...rest }) => {
      return {
        onClick: callAllHandlers(onClick, dismiss),
        ...rest,
      }
    },
    [onDismiss, dismiss],
